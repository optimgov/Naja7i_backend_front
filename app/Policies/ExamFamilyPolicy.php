...
class ExamFamilyPolicy
{
    ...
    public function view(User $user, ExamFamily $examfamily): bool
    {
        return $this->peut($user, 'catalogue.view');
    }
    ...
    public function update(User $user, ExamFamily $examfamily): bool
    {
        return $this->peut($user, 'catalogue.manage');
    }

    public function delete(User $user, ExamFamily $examfamily): bool
    {
        return false;
    }
